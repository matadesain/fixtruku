...
class CustomerKirimanRiwayat extends React.Component {
   ...
   constructor(props) {
    ...
    this.state = {
      ...
      appName:'Riwayat Kiriman'
    };
  }

  componentDidMount() {

    PostDataCustomer('muatan_kiriman',{'muatan_id':'','customer_id':this.state.customer_id})
      .then((result) => {
            ...
            <CustomerFooter />
                  ...
                  <div class="header header-fixed header-logo-left demo-shadow bottom-10 custom-header custom-tab-controls">
                      <div class="one-half one-half-custom">
                        <NavLink to="/customer-kiriman" class="button  button-full button-xs  shadow-large border-highlight color-highlight bottom-0">Aktif</NavLink>
                      </div>
                      <div class="one-half last-column last-column-custom">
                        <NavLink to="/customer-kiriman-riwayat" class="button  button-full button-xs  shadow-large bg-highlight bottom-0" >Riwayat</NavLink>
                      </div>
                      <div class="clear"></div>
                  </div>
...
export default CustomerKirimanRiwayat;
