...
class CustomerKirimanDetail extends React.Component {
   constructor(props) {
    super(props);
  ...
  componentDidMount() {
    PostDataCustomer('muatan_kiriman',{'muatan_id':this.state.muatan_id,'customer_id':this.state.customer_id})
      .then((result) => {
...
export default CustomerKirimanDetail;
