...
class VendorKirimanRiwayat extends React.Component {
            ...
            <VendorFooter />
                  ...
                  <div class="header header-fixed header-logo-left demo-shadow bottom-10 custom-header custom-tab-controls">
                      <div class="one-half one-half-custom">
                        <NavLink to="/vendor-kiriman" class="button button-border button-full button-xs  shadow-large border-highlight color-highlight bottom-0">Aktif</NavLink>
                      </div>
                      <div class="one-half last-column last-column-custom">
                        <NavLink to="/vendor-kiriman-riwayat" class="button  button-full button-xs  shadow-large bg-highlight bottom-0" >Riwayat</NavLink>
                      </div>
                      <div class="clear"></div>
                  </div>
...
export default VendorKirimanRiwayat;
